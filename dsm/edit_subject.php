<?php
    if(isset($_GET['classID'])){
        ...
        $urlSubInfo = "http://localhost:5000/subjects/show/".$user_id."/".$subject_id;
        $dataSubInfo = file_get_contents($urlSubInfo);
        $subInfo = json_decode($dataSubInfo);
    }
...
<head>
    ...
    <title>Admin Panel - Edit Subject</title>
    ...
    <main>
        <div class="col-md-12">
            ...
            <form class="row g-3" action="http://localhost:5000/subjects/addEditSubject/editSubject" method="post">
                ...
                <?php foreach($subInfo as $subValue) { ?>
                    <input type='hidden' name='subject_id' value='<?php echo $subValue->subject_id ?>'>
                    <div class="col-md-2">
                    ...
                    <div class="col-md-8">
                        ...
                        <input type="text" class="form-control" id="subject_name" name="subject_name" value="<?php echo $subValue->subject_name; ?>" >
                    </div>
                    <div class="col-md-4">
                        ...
                        <?php foreach ($teacher as $value) { ?>
                            <option value='<?php echo $value->user_id ?>' <?php echo ($subValue->user_id == $value->user_id)  ? 'selected': '';?> > <?php echo $value->user_name; ?> </option>
                        <?php }?>
                        </select>
                    </div>
                    <br>
