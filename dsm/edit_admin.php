...
<body>
    <main>
        <div class="col-md-12">
            <h4 class="text-center">Edit Info by Admin</h4> <br>
            <form class="row g-3" action="http://localhost:5000/users/register" method="post">
                <input type='hidden' id='admin_id' name='admin_id' value='<?php echo $loggedID ?>'>
                ...
                <?php foreach($list as $value) { ?>
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" id="user_type" name="user_type" placeholder="User type" value="<?php echo $value->user_type; ?>">
                    </div>
